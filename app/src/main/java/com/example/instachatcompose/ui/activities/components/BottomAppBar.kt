package com.example.instachatcompose.ui.activities.components
...
@Composable
fun BottomAppBarItemComposable(
    label: String,
    isActive: Boolean,
    activeIcon: Int,
    passiveIcon: Int,
...
fun SharedBottomAppBar(
    username: String,
    profilePic: Uri,
    startingTab: BottomAppBarItem = BottomAppBarItem.Messages,
    onTabChange: (BottomAppBarItem) -> Unit = {},
) {
    var activeItem by remember { mutableStateOf(startingTab) }
    ...
    Row(
        ...
        BottomAppBarItemComposable(
            ...
            onClick = {
                ...
                onTabChange(activeItem)
                // Add action if you have a Calls page
            }
        )
